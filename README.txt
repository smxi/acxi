acxi is a simple tool that converts music libraries to compressed versions of that library.
...
Supports configuration files at either /etc/acxi.conf, $HOME/.acxi.conf, or $HOME/.config/acxi.conf 

See top of file for instructions on how to create the configuration items.

Requires first time setup of your system music directory paths, conversion tools, etc.
