...
libraries to compressed (ogg,mp3) versions of the lossless library. 
It also can convert shn to flac. 
...
updates now and then. Changes will not break existing configurations.
